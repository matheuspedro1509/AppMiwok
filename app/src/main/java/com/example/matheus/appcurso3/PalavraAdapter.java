...
public class PalavraAdapter extends ArrayAdapter<Palavra> {
     ...
     */
    public PalavraAdapter(Activity context, ArrayList<Palavra> androidFlavors, int colorResourceId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View lstView = listItemView.findViewById(R.id.text_container);
        int color= ContextCompat.getColor(getContext(),mColorResourceId);
        lstView.setBackgroundColor(color);
